...
against a `tabular_style_template`. The template carries an ordered list
of
...
Pipe through
[`style()`](https://vthanik.github.io/tabular/reference/style.md) to add
layers.
...
per-table
[`style()`](https://vthanik.github.io/tabular/reference/style.md) call.
...
**Style verb:**
[`style()`](https://vthanik.github.io/tabular/reference/style.md) — the
same verb chains onto a spec or a template.
