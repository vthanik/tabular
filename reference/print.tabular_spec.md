...
#tabular-574680b53c { font-family: "Liberation Mono", "Courier New", Courier, monospace; color: #212529; margin: 1.5rem; }
#tabular-574680b53c .tabular-content { width: fit-content; max-width: 100%; margin: 0 auto; }
#tabular-574680b53c .tabular-title { font-size: 10pt; font-weight: 600; text-align: center; margin: .2rem 0; }
#tabular-574680b53c .tabular-pad { margin: 0; }
#tabular-574680b53c .tabular-table-wrap { overflow-x: auto; margin: .2rem 0; }
#tabular-574680b53c .tabular-table { border-collapse: collapse; font-size: 10pt; margin: 0 auto; }
#tabular-574680b53c .tabular-table { --bs-table-bg: transparent; --bs-table-accent-bg: transparent; --bs-table-border-color: transparent; width: auto; }
#tabular-574680b53c .tabular-table > :not(caption) > * > * { border-bottom-width: 0; box-shadow: none; }
#tabular-574680b53c .tabular-table th, #tabular-574680b53c .tabular-table td { padding: .35rem .6rem; }
#tabular-574680b53c .tabular-table td { text-align: left; vertical-align: top; }
#tabular-574680b53c .tabular-table thead th { font-weight: 600; text-align: center; vertical-align: bottom; }
#tabular-574680b53c .tabular-table thead tr:first-child th { border-top: 0.5pt solid #212529; }
#tabular-574680b53c .tabular-table thead tr:last-child th { border-bottom: 0.5pt solid #212529; }
#tabular-574680b53c .tabular-table thead .tabular-band { border-bottom: 0.5pt solid #adb5bd; }
#tabular-574680b53c .tabular-table tbody tr:last-child td { border-bottom: 0.5pt solid #212529; }
#tabular-574680b53c .tabular-table tbody tr td { border-top: none; }
#tabular-574680b53c .tabular-band { text-align: center; }
#tabular-574680b53c .tabular-subgroup td { text-align: center; vertical-align: middle; padding: .5rem .6rem; border-top: 1px solid #adb5bd; border-bottom: 1px solid #adb5bd; }
#tabular-574680b53c .tabular-subgroup-label { font-weight: 600; }
#tabular-574680b53c .tabular-group-header td { font-weight: 600; text-align: left; padding-top: .55rem; }
#tabular-574680b53c .tabular-blank-row td { padding: .25rem .6rem; border: none; }
#tabular-574680b53c .text-left { text-align: left; }
#tabular-574680b53c .text-center { text-align: center; }
#tabular-574680b53c .text-right { text-align: right; }
#tabular-574680b53c .tabular-table thead th.text-left { text-align: left; }
#tabular-574680b53c .tabular-table thead th.text-center { text-align: center; }
#tabular-574680b53c .tabular-table thead th.text-right { text-align: right; }
#tabular-574680b53c .valign-top { vertical-align: top; }
#tabular-574680b53c .valign-middle { vertical-align: middle; }
#tabular-574680b53c .valign-bottom { vertical-align: bottom; }
#tabular-574680b53c .tabular-footnote { font-size: 10pt; color: #495057; margin: .25rem 0; }
#tabular-574680b53c .tabular-empty { font-style: italic; color: #6c757d; }
#tabular-574680b53c .tabular-page-break-row { display: none; }
#tabular-574680b53c { --tabular-border-color: #212529; --tabular-border-color-muted: #adb5bd; --tabular-chrome-color: #495057; }
#tabular-574680b53c .tabular-page-header, #tabular-574680b53c .tabular-page-footer { display: flex; justify-content: space-between; align-items: center; padding: .5rem 0; font-size: 9pt; color: var(--tabular-chrome-color); }
#tabular-574680b53c .tabular-page-header { margin-bottom: 1rem; }
#tabular-574680b53c .tabular-page-footer { margin-top: 1rem; }
#tabular-574680b53c .tabular-page-header-left, #tabular-574680b53c .tabular-page-footer-left { flex: 1; text-align: left; }
#tabular-574680b53c .tabular-page-header-center, #tabular-574680b53c .tabular-page-footer-center { flex: 1; text-align: center; }
#tabular-574680b53c .tabular-page-header-right, #tabular-574680b53c .tabular-page-footer-right { flex: 1; text-align: right; }
@media print { #tabular-574680b53c .tabular-table-wrap { overflow-x: visible; margin: 0; } #tabular-574680b53c .tabular-table tr { page-break-inside: avoid; } #tabular-574680b53c .tabular-page-header, #tabular-574680b53c .tabular-page-footer { display: none; } #tabular-574680b53c .tabular-page-break-row { display: table-row; page-break-before: always; break-before: page; } #tabular-574680b53c .tabular-page-break-row td { border: none; padding: 0; height: 0; line-height: 0; font-size: 0; } #tabular-574680b53c .tabular-table + .tabular-table { page-break-before: always; break-before: page; } }
