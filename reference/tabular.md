...
#tabular-4b8d16e13e .tabular-caption { margin: 0; padding: 0; }
#tabular-4b8d16e13e .tabular-pad { margin: 0; line-height: 1; }
#tabular-4b8d16e13e .tabular-table-wrap { overflow-x: auto; margin: .2rem 0; }
#tabular-4b8d16e13e .tabular-table { border-collapse: collapse; font-size: 10pt; margin: 0 auto; }
#tabular-4b8d16e13e .tabular-table { --bs-table-bg: transparent; --bs-table-accent-bg: transparent; --bs-table-border-color: transparent; width: auto; }
#tabular-4b8d16e13e .tabular-table > :not(caption) > * > * { border-bottom-width: 0; box-shadow: none; }
#tabular-4b8d16e13e .tabular-table th, #tabular-4b8d16e13e .tabular-table td { padding: .18rem .6rem; }
#tabular-4b8d16e13e .tabular-table td { text-align: left; vertical-align: top; }
#tabular-4b8d16e13e .tabular-table thead th { font-weight: 600; text-align: center; vertical-align: bottom; }
#tabular-4b8d16e13e .tabular-table thead tr:first-child th { border-top: 0.5pt solid #212529; }
#tabular-4b8d16e13e .tabular-table thead tr:last-child th { border-bottom: 0.5pt solid #212529; }
#tabular-4b8d16e13e .tabular-table thead .tabular-band { background-image: linear-gradient(to right, transparent 0.5em, #adb5bd 0.5em, #adb5bd calc(100% - 0.5em), transparent calc(100% - 0.5em)); background-repeat: no-repeat; background-position: left bottom; background-size: 100% 0.5pt; }
#tabular-4b8d16e13e .tabular-table thead .tabular-band.tabular-band-flush-left { background-image: linear-gradient(to right, transparent 0px, #adb5bd 0px, #adb5bd calc(100% - 0.5em), transparent calc(100% - 0.5em)); background-repeat: no-repeat; background-position: left bottom; background-size: 100% 0.5pt; }
#tabular-4b8d16e13e .tabular-table thead .tabular-band.tabular-band-flush-right { background-image: linear-gradient(to right, transparent 0.5em, #adb5bd 0.5em, #adb5bd calc(100% - 0px), transparent calc(100% - 0px)); background-repeat: no-repeat; background-position: left bottom; background-size: 100% 0.5pt; }
#tabular-4b8d16e13e .tabular-table thead .tabular-band.tabular-band-flush-both { background-image: linear-gradient(to right, transparent 0px, #adb5bd 0px, #adb5bd calc(100% - 0px), transparent calc(100% - 0px)); background-repeat: no-repeat; background-position: left bottom; background-size: 100% 0.5pt; }
#tabular-4b8d16e13e .tabular-table tbody tr:last-child td { border-bottom: 0.5pt solid #212529; }
#tabular-4b8d16e13e .tabular-table tbody tr td { border-top: none; }
#tabular-4b8d16e13e .tabular-band { text-align: center; }
#tabular-4b8d16e13e .tabular-subgroup td { text-align: center; vertical-align: middle; padding: .15rem .6rem; }
#tabular-4b8d16e13e .tabular-subgroup-label { font-weight: 600; }
#tabular-4b8d16e13e .tabular-subgroup-bign td { text-align: center; border-bottom: 1px solid #adb5bd; }
#tabular-4b8d16e13e .tabular-subgroup-closed td { border-bottom: 1px solid #adb5bd; }
#tabular-4b8d16e13e .tabular-group-header td { font-weight: 600; text-align: left; padding-top: .55rem; }
#tabular-4b8d16e13e .tabular-blank-row td { padding: 0; border: none; height: 1em; line-height: 1em; }
#tabular-4b8d16e13e .text-left { text-align: left; }
#tabular-4b8d16e13e .text-center { text-align: center; }
#tabular-4b8d16e13e .text-right { text-align: right; }
...
#tabular-4b8d16e13e .tabular-footnote { font-size: 10pt; color: #495057; margin: .25rem 0; }
...
#tabular-4b8d16e13e .tabular-page-header-center, #tabular-4b8d16e13e .tabular-page-footer-center { flex: 1; text-align: center; }
#tabular-4b8d16e13e .tabular-page-header-right, #tabular-4b8d16e13e .tabular-page-footer-right { flex: 1; text-align: right; }
@media print { #tabular-4b8d16e13e .tabular-table-wrap { overflow-x: visible; margin: 0; } #tabular-4b8d16e13e .tabular-table tr { page-break-inside: avoid; } #tabular-4b8d16e13e .tabular-page-header, #tabular-4b8d16e13e .tabular-page-footer { display: none; } #tabular-4b8d16e13e .tabular-page-break-row { display: table-row; page-break-before: always; break-before: page; } #tabular-4b8d16e13e .tabular-page-break-row td { border: none; padding: 0; height: 0; line-height: 0; font-size: 0; } #tabular-4b8d16e13e .tabular-table + .tabular-table { page-break-before: always; break-before: page; } }
