...
#> <style>
#> #tabular-a68cd110d4 { font-family: "Liberation Mono", "Courier New", Courier, monospace; color: #212529; margin: 1.5rem; }
#> #tabular-a68cd110d4 .tabular-content { width: 100%; }
#> #tabular-a68cd110d4 .tabular-title { font-size: 10pt; font-weight: 600; text-align: center; margin: .2rem 0; }
#> #tabular-a68cd110d4 .tabular-pad { margin: 0; }
#> #tabular-a68cd110d4 .tabular-table-wrap { overflow-x: auto; margin: .2rem 0; }
#> #tabular-a68cd110d4 .tabular-table { border-collapse: collapse; font-size: 10pt; margin: 0 auto; }
#> #tabular-a68cd110d4 .tabular-table th, #tabular-a68cd110d4 .tabular-table td { padding: .35rem .6rem; }
#> #tabular-a68cd110d4 .tabular-table td { text-align: left; vertical-align: top; }
#> #tabular-a68cd110d4 .tabular-table thead th { font-weight: 600; text-align: center; vertical-align: bottom; }
#> #tabular-a68cd110d4 .tabular-table thead tr:first-child th { border-top: 0.5pt solid #212529; }
#> #tabular-a68cd110d4 .tabular-table thead tr:last-child th { border-bottom: 0.5pt solid #212529; }
#> #tabular-a68cd110d4 .tabular-table thead .tabular-band { border-bottom: 0.5pt solid #adb5bd; }
#> #tabular-a68cd110d4 .tabular-table tbody tr:last-child td { border-bottom: 0.5pt solid #212529; }
#> #tabular-a68cd110d4 .tabular-table tbody tr td { border-top: none; }
#> #tabular-a68cd110d4 .tabular-band { text-align: center; }
#> #tabular-a68cd110d4 .tabular-subgroup td { text-align: center; vertical-align: middle; padding: .5rem .6rem; border-top: 1px solid #adb5bd; border-bottom: 1px solid #adb5bd; }
#> #tabular-a68cd110d4 .tabular-subgroup-label { font-weight: 600; }
#> #tabular-a68cd110d4 .tabular-group-header td { font-weight: 600; text-align: left; padding-top: .55rem; }
#> #tabular-a68cd110d4 .tabular-blank-row td { padding: .25rem .6rem; border: none; }
#> #tabular-a68cd110d4 .text-left { text-align: left; }
#> #tabular-a68cd110d4 .text-center { text-align: center; }
#> #tabular-a68cd110d4 .text-right { text-align: right; }
#> #tabular-a68cd110d4 .tabular-table thead th.text-left { text-align: left; }
#> #tabular-a68cd110d4 .tabular-table thead th.text-center { text-align: center; }
#> #tabular-a68cd110d4 .tabular-table thead th.text-right { text-align: right; }
#> #tabular-a68cd110d4 .valign-top { vertical-align: top; }
#> #tabular-a68cd110d4 .valign-middle { vertical-align: middle; }
#> #tabular-a68cd110d4 .valign-bottom { vertical-align: bottom; }
#> #tabular-a68cd110d4 .tabular-footnote { font-size: 10pt; color: #495057; margin: .25rem 0; }
#> #tabular-a68cd110d4 .tabular-empty { font-style: italic; color: #6c757d; }
#> #tabular-a68cd110d4 .tabular-page-break-row { display: none; }
#> #tabular-a68cd110d4 { --tabular-border-color: #212529; --tabular-border-color-muted: #adb5bd; --tabular-chrome-color: #495057; }
#> #tabular-a68cd110d4 .tabular-page-header, #tabular-a68cd110d4 .tabular-page-footer { display: flex; justify-content: space-between; align-items: center; padding: .5rem 0; font-size: 9pt; color: var(--tabular-chrome-color); }
#> #tabular-a68cd110d4 .tabular-page-header { margin-bottom: 1rem; }
#> #tabular-a68cd110d4 .tabular-page-footer { margin-top: 1rem; }
#> #tabular-a68cd110d4 .tabular-page-header-left, #tabular-a68cd110d4 .tabular-page-footer-left { flex: 1; text-align: left; }
#> #tabular-a68cd110d4 .tabular-page-header-center, #tabular-a68cd110d4 .tabular-page-footer-center { flex: 1; text-align: center; }
#> #tabular-a68cd110d4 .tabular-page-header-right, #tabular-a68cd110d4 .tabular-page-footer-right { flex: 1; text-align: right; }
#> @media print { #tabular-a68cd110d4 .tabular-table-wrap { overflow-x: visible; margin: 0; } #tabular-a68cd110d4 .tabular-table tr { page-break-inside: avoid; } #tabular-a68cd110d4 .tabular-page-header, #tabular-a68cd110d4 .tabular-page-footer { display: none; } #tabular-a68cd110d4 .tabular-page-break-row { display: table-row; page-break-before: always; break-before: page; } #tabular-a68cd110d4 .tabular-page-break-row td { border: none; padding: 0; height: 0; line-height: 0; font-size: 0; } #tabular-a68cd110d4 .tabular-table + .tabular-table { page-break-before: always; break-before: page; } }
#> </style>
#> <div id="tabular-a68cd110d4" class="tabular-doc" style="overflow-x:auto;max-width:100%;"><div class="tabular-content">
...
#> <style>
#> #tabular-f1343f6ff8 { font-family: "Liberation Mono", "Courier New", Courier, monospace; color: #212529; margin: 1.5rem; }
#> #tabular-f1343f6ff8 .tabular-content { width: 100%; }
#> #tabular-f1343f6ff8 .tabular-title { font-size: 10pt; font-weight: 600; text-align: center; margin: .2rem 0; }
#> #tabular-f1343f6ff8 .tabular-pad { margin: 0; }
#> #tabular-f1343f6ff8 .tabular-table-wrap { overflow-x: auto; margin: .2rem 0; }
#> #tabular-f1343f6ff8 .tabular-table { border-collapse: collapse; font-size: 10pt; margin: 0 auto; }
#> #tabular-f1343f6ff8 .tabular-table th, #tabular-f1343f6ff8 .tabular-table td { padding: .35rem .6rem; }
#> #tabular-f1343f6ff8 .tabular-table td { text-align: left; vertical-align: top; }
#> #tabular-f1343f6ff8 .tabular-table thead th { font-weight: 600; text-align: center; vertical-align: bottom; }
#> #tabular-f1343f6ff8 .tabular-table thead tr:first-child th { border-top: 0.5pt solid #212529; }
#> #tabular-f1343f6ff8 .tabular-table thead tr:last-child th { border-bottom: 0.5pt solid #212529; }
#> #tabular-f1343f6ff8 .tabular-table thead .tabular-band { border-bottom: 0.5pt solid #adb5bd; }
#> #tabular-f1343f6ff8 .tabular-table tbody tr:last-child td { border-bottom: 0.5pt solid #212529; }
#> #tabular-f1343f6ff8 .tabular-table tbody tr td { border-top: none; }
#> #tabular-f1343f6ff8 .tabular-band { text-align: center; }
#> #tabular-f1343f6ff8 .tabular-subgroup td { text-align: center; vertical-align: middle; padding: .5rem .6rem; border-top: 1px solid #adb5bd; border-bottom: 1px solid #adb5bd; }
#> #tabular-f1343f6ff8 .tabular-subgroup-label { font-weight: 600; }
#> #tabular-f1343f6ff8 .tabular-group-header td { font-weight: 600; text-align: left; padding-top: .55rem; }
#> #tabular-f1343f6ff8 .tabular-blank-row td { padding: .25rem .6rem; border: none; }
#> #tabular-f1343f6ff8 .text-left { text-align: left; }
#> #tabular-f1343f6ff8 .text-center { text-align: center; }
#> #tabular-f1343f6ff8 .text-right { text-align: right; }
#> #tabular-f1343f6ff8 .tabular-table thead th.text-left { text-align: left; }
#> #tabular-f1343f6ff8 .tabular-table thead th.text-center { text-align: center; }
#> #tabular-f1343f6ff8 .tabular-table thead th.text-right { text-align: right; }
#> #tabular-f1343f6ff8 .valign-top { vertical-align: top; }
#> #tabular-f1343f6ff8 .valign-middle { vertical-align: middle; }
#> #tabular-f1343f6ff8 .valign-bottom { vertical-align: bottom; }
#> #tabular-f1343f6ff8 .tabular-footnote { font-size: 10pt; color: #495057; margin: .25rem 0; }
#> #tabular-f1343f6ff8 .tabular-empty { font-style: italic; color: #6c757d; }
#> #tabular-f1343f6ff8 .tabular-page-break-row { display: none; }
#> #tabular-f1343f6ff8 { --tabular-border-color: #212529; --tabular-border-color-muted: #adb5bd; --tabular-chrome-color: #495057; }
#> #tabular-f1343f6ff8 .tabular-page-header, #tabular-f1343f6ff8 .tabular-page-footer { display: flex; justify-content: space-between; align-items: center; padding: .5rem 0; font-size: 9pt; color: var(--tabular-chrome-color); }
#> #tabular-f1343f6ff8 .tabular-page-header { margin-bottom: 1rem; }
#> #tabular-f1343f6ff8 .tabular-page-footer { margin-top: 1rem; }
#> #tabular-f1343f6ff8 .tabular-page-header-left, #tabular-f1343f6ff8 .tabular-page-footer-left { flex: 1; text-align: left; }
#> #tabular-f1343f6ff8 .tabular-page-header-center, #tabular-f1343f6ff8 .tabular-page-footer-center { flex: 1; text-align: center; }
#> #tabular-f1343f6ff8 .tabular-page-header-right, #tabular-f1343f6ff8 .tabular-page-footer-right { flex: 1; text-align: right; }
#> @media print { #tabular-f1343f6ff8 .tabular-table-wrap { overflow-x: visible; margin: 0; } #tabular-f1343f6ff8 .tabular-table tr { page-break-inside: avoid; } #tabular-f1343f6ff8 .tabular-page-header, #tabular-f1343f6ff8 .tabular-page-footer { display: none; } #tabular-f1343f6ff8 .tabular-page-break-row { display: table-row; page-break-before: always; break-before: page; } #tabular-f1343f6ff8 .tabular-page-break-row td { border: none; padding: 0; height: 0; line-height: 0; font-size: 0; } #tabular-f1343f6ff8 .tabular-table + .tabular-table { page-break-before: always; break-before: page; } }
#> </style>
#> <div id="tabular-f1343f6ff8" class="tabular-doc" style="overflow-x:auto;max-width:100%;"><div class="tabular-content">
#> <p class="tabular-pad">&nbsp;</p>
