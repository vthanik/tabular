...
#> <style>
#> .tabular-doc { font-family: "Liberation Serif", "Times New Roman", Times, serif; color: #212529; margin: 1.5rem; }
...
#> .tabular-page-header, .tabular-page-footer { display: flex; justify-content: space-between; align-items: center; padding: .5rem 0; font-size: 8pt; color: var(--tabular-chrome-color); }
...
#> </style>
#> <div id="tabular_RmBV2zbiPl" class="tabular-doc" style="overflow-x:auto;max-width:100%;"><div class="tabular-content">
