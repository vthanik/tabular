...
#tabular-d1273b0db5 .tabular-table { --bs-table-bg: transparent; --bs-table-accent-bg: transparent; --bs-table-border-color: transparent; width: auto; }
#tabular-d1273b0db5 .tabular-table > :not(caption) > * > * { border-bottom-width: 0; box-shadow: none; }
