# tabular: Render Tables, Listings, and Figures for Clinical Submissions
...
same page chrome as a table. Built for Clinical Data Interchange
Standards Consortium (CDISC) Analysis Data Model (ADaM) workflows and
