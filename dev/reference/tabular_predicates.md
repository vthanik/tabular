...
| `is_tabular_spec()` | `tabular_spec` | [`tabular()`](https://vthanik.github.io/tabular/dev/reference/tabular.md) and every build verb |
| `is_tabular_grid()` | `tabular_grid` | [`as_grid()`](https://vthanik.github.io/tabular/dev/reference/as_grid.md) |
| `is_col_spec()` | `col_spec` | [`col_spec()`](https://vthanik.github.io/tabular/dev/reference/col_spec.md) |
| `is_header_node()` | `header_node` | [`headers()`](https://vthanik.github.io/tabular/dev/reference/headers.md) (internal nodes) |
| `is_sort_spec()` | `sort_spec` | [`sort_rows()`](https://vthanik.github.io/tabular/dev/reference/sort_rows.md) |
| `is_style_node()` | `style_node` | [`style()`](https://vthanik.github.io/tabular/dev/reference/style.md) (per-cell style) |
| `is_style_layer()` | `style_layer` | [`style()`](https://vthanik.github.io/tabular/dev/reference/style.md) (one per call) |
| `is_style_spec()` | `style_spec` | [`style()`](https://vthanik.github.io/tabular/dev/reference/style.md) (the cascade root) |
...
#tabular-763eb95427 { font-family: "Courier New", Courier, "Liberation Mono", monospace; color: #212529; margin: 1.5rem; font-size: 10pt; line-height: 1.3; }
