...
| `col_spec` | per-column DSL (label, format, align, width, ...) | [`col_spec()`](https://vthanik.github.io/tabular/dev/reference/col_spec.md) |
...
| `row_group_spec` | row-grouping plan (keys + per-key display / skip) | internal — built by [`group_rows()`](https://vthanik.github.io/tabular/dev/reference/group_rows.md) |
