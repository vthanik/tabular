...
TFL rendering for regulatory submissions (RTF / PDF / HTML / LaTeX). Replaces arframe.

Global directives load from `~/.claude/CLAUDE.md`. This file holds project-specific shared conventions.
